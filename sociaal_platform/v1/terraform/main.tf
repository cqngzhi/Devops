...
module "ec2" {
  ...
  private_subnet    = module.network.aws_subnet.private  # IDs van private subnets
  security_group_id = module.network.aws_security_group.s_platform_sg  # Het ID van de beveiligingsgroep
